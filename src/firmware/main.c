...
int main(void)
{
	...
	set_initial_keyval(0,IO_JOYK_0_0,11,3,1);	// UP (UP)
	set_initial_keyval(1,IO_JOYK_1_0,11,4,1);	// DOWN (DOWN)
	set_initial_keyval(2,IO_JOYK_2_0,10,4,1);	// LEFT (LEFT)
	set_initial_keyval(3,IO_JOYK_3_0,12,4,1);	// RIGHT (RIGHT)
	set_initial_keyval(4,IO_JOYK_4_0,13,2,2);	// ENTER (A)
